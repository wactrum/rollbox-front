...
import { Bars4Icon as MenuIcon, MagnifyingGlassIcon as SearchIcon, ShoppingBagIcon, XMarkIcon as XIcon } from '@heroicons/vue/24/outline'
import { ChevronDownIcon, PlusIcon as PlusSmIcon } from '@heroicons/vue/24/solid'
